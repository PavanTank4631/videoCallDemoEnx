...
export default class EnxConferenceScreen extends Component {
  ...
  async componentWillMount() {
    console.log('123456788',this.props.route.params)
    const {token, username, permissionsError} = this.props.route.params
  ...
  constructor(props) {
    ...
    this.roomEventHandlers = {
      ...
      eventError: (event) => {
        const {permissionsError} = this.props.route.params
